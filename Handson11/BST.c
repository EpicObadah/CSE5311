...
int main()
{
    ...
    printf("Minimum value: %d\n", minNode->value); //searcg for min
    printf("Maximum value: %d\n", maxNode->value); // search for max

    int searchValue = 40;
    Node* searchResult = search(tree->root, searchValue);
    if (searchResult) //show an example of a node being searched for.
    {
